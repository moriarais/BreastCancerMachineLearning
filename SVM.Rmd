...
predicted_probs_80 <- predict(svm_model_subtype_80, newdata = test_data_80, probability = TRUE)
binary_predicted_probs_80 <- model.matrix(~ predictions_subtype_80 + 0, data = data.frame(predictions_subtype_80))
